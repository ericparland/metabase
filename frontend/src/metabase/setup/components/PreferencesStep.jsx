                ...
                <section className="SetupStep rounded full relative SetupStep--active">
                    ...
                    <form onSubmit={this.formSubmitted.bind(this)} noValidate>
                        <div className="Form-field Form-offset">
                            In order to help us improve RC Data Tool, we'd like to collect certain data about usage through Google Analytics.  <a className="link" href={"http://localhost/docs/"+tag+"/information-collection.html"} target="_blank">Here's a full list of everything we track and why.</a>
                        </div>
