                ...
                <section className="SetupStep rounded full relative SetupStep--active">
                    ...
                    <form onSubmit={this.formSubmitted.bind(this)} noValidate>
                        <div className="Form-field Form-offset">
                            In order to help us improve RC Data Tool, we'd like to collect certain data about usage through Google Analytics.  <a className="link" href={"http://www.metabase.com/docs/"+tag+"/information-collection.html"} target="_blank">Here's a full list of everything we track and why.</a>
                        </div>
                        ...
                        <div className="Form-field Form-offset mr4">
                            <div style={{borderWidth: "2px"}} className="flex align-center bordered rounded p2">
                                ...
                                <span className="ml1">Allow RC Data Tool to anonymously collect usage events</span>
                            </div>
                        </div>
                        ...
                        { allowTracking ?
                            <div className="Form-field Form-offset">
                                <ul style={{listStyle: "disc inside", lineHeight: "200%"}}>
                                    <li>RC Data Tool <span style={{fontWeight: "bold"}}>never</span> collects anything about your data or question results.</li>
